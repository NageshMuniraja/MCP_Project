...
build a customer MCP server to give any AI app access to a toolset for an  Virtual Assistant.
...
## Customizing virtualassistance Behavior

### Update Personal Details and Preferences
1. Locate the `prompts/va.md` file in your project directory
2. Customize the file with:
   - Communication preferences
   - Specific instructions for handling tasks
   - Any other relevant guidelines for virtual assistance
